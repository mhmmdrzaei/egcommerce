...
function wc_get_gallery_image_html( $attachment_id, $main_image = false ) {
	...
	return '<div data-thumb="' . esc_url( $thumbnail_src[1] ) . '" data-thumb-alt="' . esc_attr( $alt_text ) . '" class="woocommerce-product-gallery__image"><a href="' . esc_url( $full_src[0] ) . '">' . $image . '</a></div>';
}
